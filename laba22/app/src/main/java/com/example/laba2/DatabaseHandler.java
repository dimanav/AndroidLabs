...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void delUser(String Name){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(DBContract.UserEntry.TABLE_NAME, DBContract.UserEntry.COLUMN_NAME_LOGIN + "=?", new String[]{Name});
        db.close();
    }

    public void updPass(String Pass, String Name){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(DBContract.UserEntry.COLUMN_NAME_PASS, Pass);
        db.update(DBContract.UserEntry.TABLE_NAME, values, DBContract.UserEntry.COLUMN_NAME_LOGIN + "=?", new String[]{Name});
        db.close();
    }
